    ...
    return (
        <div className="mx-[15%] flex items-center">
            <div className="text-center mx-[5%] w-1/5">
                <div className="font-[Museno-900] lg:text-[32px] text-[16px]">ABOUT</div>
                <div className="font-['Noto-Sans-Regular'] lg:text-[12px] text-[4px]">ContentsCreationCircleについて</div>
            </div>
            <p className="font-['Noto-Sans-Regular'] lg:text-[12px] text-[6px] w-4/5">
